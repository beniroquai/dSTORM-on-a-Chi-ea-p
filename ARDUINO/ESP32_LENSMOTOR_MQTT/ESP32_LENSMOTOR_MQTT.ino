...
#define STEPPER_X_FWD     "stepper/lens/x/fwd"
#define STEPPER_X_BWD     "stepper/lens/x/bwd"
#define STEPPER_Y_FWD     "stepper/lens/y/fwd"
#define STEPPER_Y_BWD     "stepper/lens/y/bwd"

#define CLIENT_ID "ESP32Client_lensmotor";
