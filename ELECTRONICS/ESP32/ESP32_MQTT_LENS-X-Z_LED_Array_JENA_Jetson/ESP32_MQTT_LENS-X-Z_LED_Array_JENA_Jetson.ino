...
std::string SETUP = "cellstorm";      //S006->Aurelie; S004->Barbora
std::string COMPONENT = "cellstorm"; // LAR01 //LED01 // MOT02=x,y // MOT01=z
...
#define NAME_TO_RESOLVE "bene-desktop.local"
...
const char *COMMANDSET[NCOMMANDS] = {"NA", "PXL", "HLINE", "VLINE", "RECT", "CIRC", "LEFT", "RIGHT", "TOP", "BOTTOM", "CLEAR", "PRESET", "SETPRE", "FLYBY", "ALIVE","DRVX", "DRVY", "DRVZ", "FLUO"};
const char *INSTRUCTS[NCOMMANDS] = {"1", "4", "4", "4", "8", "6", "3", "3", "3", "3", "0", "1", "1", "1", "1", "1", "1", "1", "1"};
